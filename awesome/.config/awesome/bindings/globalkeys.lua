        ...
        awful.key({ "Mod1" }, "F4",
            function()
                awful.spawn.with_shell(
                    ...
                    -theme-str 'window {width: 12em;} listview {lines: 8;}'
                    ]]
                )
            end,
            { description = "rofi power menu", group = "awesome" }),

        awful.key({ },"XF86HomePage",
            function() awful.spawn.with_shell("pkill glava || glava --desktop") end,
            { description = "Start galva (Visualizer)", group = "launcher" }),
